...
<div class="card col-sm-8">
  <h5 class="card-body h6">Checker Marisa</h5>
  <div class="card-body">
    <center><span>Liberdade não tem preço, mano pega a visão</span></center>
<div class="md-form">
	<div class="col-md-12">
  <textarea type="text" style="text-align: center;" id="lista" class="md-textarea form-control" rows="2"></textarea>
  <label for="lista">Email e Senha</label>
</div>
</div>
<center>
...
<footer >
    ...
    <div class="footer-copyright text-center py-3">By Root:
